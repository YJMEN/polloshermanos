...
if ($result->num_rows > 0) {
    ...
    echo "</tbody></table>";
    echo "<button onclick=\"window.location.href='clientes.html'\">NUEVO INGRESO</button><br>";
    echo "<button onclick=\"window.location.href='registros.html'\">VOLVER A REGISTROS</button>";
    
} else {
    echo "<h2>No se encontraron registros.</h2>";
    echo "<button onclick=\"window.location.href='clientes.html'\">INGRESAR CLIENTE</button><br>";
    echo "<button onclick=\"window.location.href='registros.html'\">VOLVER A REGISTROS</button>";
}
